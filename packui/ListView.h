...
#include "cocos-ext.h"
#include "TextViewDBSource.h"


USING_NS_CC_EXT;

// <TextView所使用的CCTableView || 自上而下的 || 变长的
...
public:
	...
	void _updateContentSize()
	{
		...
		this->setContentSize(((TextViewDBSource*) m_pDataSource)->getwholesize());
	...
	{
		return CCPoint(0,((TextViewDBSource*) m_pDataSource)->offsetfromidx(index));
	}

	unsigned int _indexFromOffset(CCPoint offset)
	{
		return ((TextViewDBSource*) m_pDataSource)->indexfromoffset(offset.y);
	}
