...
bool LStatBar::init()
{
	do 
	{
		...
		//////////////////////////////////////////////////////////////////////////
		// <Clip Head
		CCSprite* tbcs = CCSprite::create("Images/hud_ls_base.png");
...
void LStatBar::setHead(const char* asH)
{
	StatBar::setHead(asH);
	...
	ms_Head->setPosition(ccp(240,70));
...
{
	if(aec) CCLog(">[LStatBar] Left: %s, %s", aec->m_pChara->m_sName.c_str(), aec->name.c_str());
	StatBar::SetContent(aec);
	BattleField::sharedBattleField()->meTarget = aec;
}
